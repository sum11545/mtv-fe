    ...
    <>
      ...
      >
        ...
        <Typography
          ...
          paragraph
        >
          By using the Platform including but not limited to accessing or
          visiting or browsing the website, You indicate your acceptance to
        ...
        >
          ...
          codes, etc. available or accessible on the Platform. The Platform is
        ...
        <Typography
          ...
          paragraph
        >
          Additional agreement(s) like User or Service Agreement may apply to
          use certain services through the Platform. Such agreement(s) will be
          disclosed to You in connection with the applicable service or
          activity. Any such supplemental agreements are in addition to these
          terms, and in the event of a conflict, prevail over these Terms.
        </Typography>
        ...
        >
          ...
          transparent, actionable and one-of-its-kind - Content and
          intelligence.
        </Typography>
        <Typography
          variant="termsText"
        ...
        <List sx={{ pl: 0, mb: isMobile ? 0.5 : 1, pt: 0, pb: 0 }}>
        ...
        >
          ...
          on platform for personal, non-commercial transitory viewing only. This
          is the grant of a limited, non-exclusive, non-assignable and
          ...
          access and use shall be governed by all of the terms and conditions
          set forth herein. and under this license you may not:
        </Typography>
        <List sx={{ pl: isMobile ? 1 : 2, py: 0, mb: 0 }}>
          <ListItem sx={{ py: 0, px: 0 }}>
            <ListItemIcon sx={{ minWidth: isMobile ? "16px" : "20px" }}>
              <Circle
                sx={{
        ...
        <Typography
          ...
          paragraph
        >
          You may provide comments and suggestions regarding the Platform, but
          You are not required to do so. If you provide comments or suggestions,
          the Company may use that feedback without restriction, and You hereby
        ...
        <List sx={{ pl: 0, mb: 0 }}>
          <ListItem sx={{ py: isMobile ? 0.25 : 0.5, px: 0 }}>
            <ListItemText
              primaryTypographyProps={{
                variant: "termsText",
                ...fontStyles.openSans.regular,
              ...
              primary={
                ...
                >
                  ...
                  modifications and derivative works of them and all
                  Intellectual Property Rights in all of them. Your rights to
                  use the Platform are limited to those expressly granted in
                  these Terms.
                </Typography>
              }
            />
          ...
          <Box ml={{ xs: 1, sm: 2 }}>
            ...
            <Box display="flex" mb={0.5}>
              ...
              >
                ...
                violates the privacy rights of any third party (including
                without limitation, copyright, trademark, patent, trade secret,
                or other intellectual property right, moral right, or right of
                publicity).
              </Typography>
            </Box>
            ...
            <Box display="flex" mb={0.5}>
              ...
              <Typography
                ...
                variant="termsText"
              >
                contains any data that You do not have a right to upload into
                the Platform.
              </Typography>
            </Box>
          ...
          <Box ml={{ xs: 1, sm: 2 }}>
            ...
            <Box display="flex" mb={0.5}>
              ...
              <Typography
                ...
                variant="termsText"
              >
                use the Platform in any way that restricts or inhibits the use
                of the Platform;
              </Typography>
            </Box>
            ...
            <Box display="flex" mb={0.5}>
              ...
              <Typography
                ...
                variant="termsText"
              >
                access or attempt to access any of the Company's systems,
                programs or data that are not made available for public use, or
                attempt to bypass any registration processes on the Platform or
                any of the Platform's security and traffic management devices;
                or
              </Typography>
            </Box>
            ...
            <Box display="flex" mb={0.5}>
              ...
              <Typography
                ...
                variant="termsText"
              >
                attempt to decompile, disassemble, re-engineer or reverse
                engineer the Platform or otherwise create or attempt to create
                or permit, allow, or assist others to extract source code of the
                Platform, its structural framework or allow or facilitate a
                third party, to violate or infringe any rights of MoneyTV;
              </Typography>
            </Box>
            ...
            <Box display="flex" mb={0.5}>
              ...
              <Typography
                ...
                variant="termsText"
              >
                misuse your right to the Platform by introducing viruses,
                trojans, worms or other material likely to cause harm to the
                Platform.
              </Typography>
            </Box>
          </Box>
            ...
            <ListItemText
              ...
              primary={
                ...
                >
                  ...
                  circumstances of disclosure and excluding any information that
                  was or has become publicly available without the receiving
        ...
        <Typography
          ...
          paragraph
        >
          This Agreement and the license rights granted hereunder shall remain
          in full force and effect unless terminated or cancelled for any of the
          following reasons:
        </Typography>
        <List sx={{ pl: isMobile ? 1 : 2, mb: 0, py: 0 }}>
          <ListItem sx={{ py: 0, px: 0 }}>
            <ListItemText
              primaryTypographyProps={{
                variant: "termsText",
        ...
        >
          ...
          right or relief to which MoneyTV may be entitled, at law or in equity.
          Upon termination of this User Agreement, all rights granted to you
          will terminate and revert to MoneyTV. Except as set forth herein,
          regardless of the reason for cancellation or termination of this
          Agreement, the fee charged if any for access to MoneyTV is not
