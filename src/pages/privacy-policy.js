    ...
    <>
      ...
      >
        ...
        >
          ...
          information we collect, how we collect, receive, store, disclose,
          share, and use your personal data for the purpose of your
          participation and consumption of our products and/or services offered
          by us through our website and/or software application ("Platform") or
          during any interaction with us, and how you can exercise your privacy
        ...
        <Typography
          ...
          paragraph
        >
          We hope you take some time to read through our Privacy Policy
        ...
        >
          ...
          ), and/or any related services, sales, marketing or events. By
          visiting and/or using our Platform, you are consenting to process your
          personal data in the manner as set forth in this Policy.
        </Typography>
        ...
        >
          ...
          request for these products and/or services within the Indian
          territory.
        </Typography>
        ...
        >
          ...
          means a wholly or partly automated operation or set of operations
          performed on digital personal data, and includes operations such as
        ...
        <List sx={{ pl: { xs: 2, sm: 4 }, pt: 0 }}>
          <ListItem sx={{ py: 0, alignItems: "flex-start" }}>
            <ListItemIcon
              sx={{ minWidth: { xs: "16px", sm: "20px" }, pt: 1.2 }}
            >
              <Circle
                sx={{
        ...
        <Typography
          ...
          paragraph
        >
          You may choose to provide us with the data, which is essential for us
          to deliver the products and/or services you request. Without this
          data, we may not be able to provide you with all the requested
          products and/or services. We may collect the data when you do any of
          the following:
        </Typography>
        <List sx={{ pl: { xs: 2, sm: 4 }, pt: 0 }} dense>
          <ListItem sx={{ py: 0 }} alignItems="flex-start">
            <ListItemIcon sx={{ minWidth: { xs: "16px", sm: "20px" } }}>
              <Circle
                sx={{
                  fontSize: { xs: "6px", sm: "8px" },
                  color: "text.primary",
            ...
            <ListItemText
              primary={
                <Typography
                  ...
                  paragraph
                >
                  Get in touch with us for support or to provide
                  feedback/queries
                </Typography>
              }
            />
        ...
        >
          ...
          surveys, or communicate with us. This data may include your name,
          e-mail id, mobile number, etc.
        </Typography>
        ...
        <Typography
          ...
          paragraph
        >
          If you connect your social media account to our Platform, you will
          share certain personal data from your social media account with us.
          This may include your name, email address, photo, list of social media
          contacts, and any other data you make accessible to us.
        </Typography>
        ...
        <List sx={{ pl: { xs: 2, sm: 4 }, pt: 0, pb: 0 }} dense>
          <ListItem sx={{ py: 0 }} alignItems="flex-start">
            <ListItemIcon sx={{ minWidth: { xs: "16px", sm: "20px" } }}>
              <Circle
                sx={{
            ...
            <ListItemText
              primary={
                <Typography
                  ...
                  paragraph
                >
                  Processing for legitimate uses where processing is necessary
                  in order to provide you with our products and/or services,
                  such as:
                </Typography>
              }
            />
        ...
        <Box pl={{ xs: 4, sm: 8 }} pt={1} mt={-1} mb={1.5}>
          <Box display="flex" mb={0.5}>
            <Typography
              sx={{
                minWidth: { xs: "1.5rem", sm: "1.8rem" },
                fontWeight: 700,
                ...fontStyles.openSans.regular,
              }}
            >
          ...
          <Box display="flex" mb={0.5}>
            ...
            <Typography
              ...
              variant="privacyPolicyText"
            >
              For legal and compliance reasons, such as the prevention,
              detection, or investigation of a crime, loss prevention or
              prevention of fraud
            </Typography>
          </Box>
          <Box display="flex" mb={0.5}>
        ...
        >
          ...
          this policy, or for purposes which are reasonably compatible to the
          ones described.
        </Typography>

        <List sx={{ pl: { xs: 1, sm: 2 }, pt: 0, pb: 0, mt: 0.5 }} dense>
          <ListItem sx={{ py: 0 }} alignItems="flex-start">
            <ListItemIcon sx={{ minWidth: { xs: "16px", sm: "20px" } }}>
              <Circle
                sx={{
        ...
        <Box pl={{ xs: 3, sm: 7 }} mt={1}>
          ...
          <Box display="flex" mb={0.5}>
            ...
            <Typography
              ...
              variant="privacyPolicyText"
            >
              Provision for you to subscribe the premium features of our
              Platform
            </Typography>
          </Box>
          <Box display="flex" mb={0.5}>
          ...
          <Box display="flex" mb={0.5}>
            ...
            <Typography
              ...
              variant="privacyPolicyText"
            >
              To provide multiple rewards & offers to you for our products
              and/or services
            </Typography>
          </Box>
          <Box display="flex" mb={0.5}>
          ...
          <Box display="flex" mb={0.5}>
            ...
            <Typography
              ...
              variant="privacyPolicyText"
            >
              Provide online or offline products and/or services such as
              contests and employment opportunities
            </Typography>
          </Box>
          <Box display="flex" mb={0.5}>
            <Typography
          ...
          <Box display="flex" mb={0.5}>
            ...
            >
              ...
              request it or when we believe our products and/or services may be
              of interest to you. If we intend to share electronic marketing
              with you, we will ask for your consent where required and you can
              opt out at any time
            </Typography>
          </Box>
          <Box display="flex" mb={0.5}>
        ...
        <List sx={{ pl: { xs: 1, sm: 2 }, pt: 0, pb: 0, mt: 1 }} dense>
          <ListItem sx={{ py: 0 }} alignItems="flex-start">
            <ListItemIcon sx={{ minWidth: { xs: "16px", sm: "20px" } }}>
              <Circle
                sx={{
            ...
            <ListItemText
              primary={
                <Typography
                  ...
                  paragraph
                >
                  To manage and improve our processes and our business
                  operations.
                </Typography>
              }
            />
        ...
        <Box pl={{ xs: 3, sm: 7 }} pt={1} pb={1}>
          ...
          <Box display="flex" mb={0.5}>
            ...
            <Typography
              ...
              variant="privacyPolicyText"
            >
              Perform data analyses, auditing and research to help us deliver
              and improve our digital Platform, content and products and/or
              services
            </Typography>
          </Box>
          <Box display="flex" mb={0.5}>
            ...
            >
              ...
              with our products and/or services to understand which parts of our
        ...
        >
          ...
          relation to the data and personal data that is processed by us. We
          take reasonable measures to protect all personal data from
          unauthorized processing or accidental disclosure, alteration, misuse,
          destruction or loss or unauthorized access and modification that
          compromises the confidentiality, integrity, and availability of such
          data.
        </Typography>
        <Typography
          variant="privacyPolicyText"
        ...
        >
          ...
          the inherent nature of the Internet, we cannot guarantee that any
          data, during transmission or while stored on our systems, will be safe
          and secure from intrusion by others. Although we will do our best to
              ...
              primary={
                <Box sx={{ textAlign: "justify" }}>
                  ...
                  >
                    ...
                    provide Your consent or to withdraw Your consent at any
                    time. This does not affect the lawfulness of the processing
              ...
              primary={
                <Box sx={{ textAlign: "justify" }}>
                  ...
                  <Typography
                    ...
                    paragraph
                  >
                    You may have the right to access the User Information that
                    we hold about You.
                  </Typography>
                </Box>
              }
              ...
              primary={
                <Box sx={{ textAlign: "justify" }}>
                  ...
                  >
                    ...
                    processing of Your User Information in certain circumstances
                    (for example, where You believe that the User Information we
              ...
              primary={
                <Box sx={{ textAlign: "justify" }}>
                  ...
                  >
                    ...
                    Company, in case you do not wish provide certain such data
                    or seek to withdraw Your consent or information/data already
                    provided, or wish to opt out from a particular service or
                    wish to erase certain information / data or seek restriction
                    in processing of certain such information / data, in such
                    cases, the Company may not be in a position to continue
                    provisioning of its services and shall have the right to
                    de-register / debar You from the use of the Platform, until
                    such time the requisite data/information and the consents
                    are provided.
                  </Typography>
                </Box>
              }
        ...
        >
          ...
          share your personal data in the following situations and recipients
          who either have a need to know and who will process it for us based on
        ...
        >
          ...
          advertisers, contractors or agents who perform services for us or on
          our behalf and require access to such information to do that work. For
          eg. data analysis, email delivery, hosting services, customer service
          and marketing newsletters, promotions and offers. We may allow
          ...
          Platform over time. This information may be used to, among other
          things, analyse and track data, determine the popularity of certain
          content and better understand online activity. These external service
          providers shall process your personal data on our behalf subject to
          appropriate safeguards only insofar as it is necessary for them to
          provide their products and/or services to us. Our prior authorization
          is required before they are permitted to transfer responsibility for
          processing personal data to a third party. Unless described in this
        ...
        >
          ...
          We provide personal data to our affiliates and other trusted
          ...
          confidentiality and security measures. In the event if we merge with
        ...
        <Typography
          ...
          paragraph
        >
          We may transfer your personal data to our affiliates or third parties
          in territories outside India for the purposes described in this Policy
          in accordance with applicable data protection laws, provided that no
          such restriction is notified by the Government/ appropriate authority.
        </Typography>
        ...
        <Typography
          ...
          paragraph
        >
          We will retain your personal data which we have collected for as long
          as we reasonably consider it necessary for achieving the
          abovementioned purposes and as is permissible under applicable law
          (such as tax, accounting or other legal requirements). This is
        ...
        >
          ...
          However, we may archive and/or retain your personal data for as long
          as there are statutory retention obligations or potential legal claims
            ...
            <ListItemText
              primary={
                <Typography
                  ...
                  paragraph
                >
                  The account shall not be deleted till the time any
                  transactions are open on the platform.
                </Typography>
              }
            />
          </ListItem>
            ...
            <ListItemText
              primary={
                ...
                >
                  ...
                  statutory proceeding or receipt of any legal and / or
                  regulatory direction to that effect, we may be required by the
                  law to retain your Personal Data for longer periods.
                </Typography>
              }
            />
          </ListItem>
            ...
            <ListItemText
              primary={
                <Typography
                  ...
                  paragraph
                >
                  Subject to above, all your personal details submitted,
                  financial data submitted etc. shall be deleted or
                  de-identified so that it is anonymous and not attributable to
                  You, within reasonable time, not exceeding 90 days.
                </Typography>
              }
            />
          </ListItem>
        ...
        >
          ...
          products and/or services are not designed for any person who is under
          18 years of age, and we do not knowingly permit such persons to
          register for products and/ or services or share data through any of
          the web forms without verifiable consent from minors' parents or
          lawful guardians. If we learn that personal information from users
          less than 18 years of age has been collected, we will take reasonable
          measures to promptly delete such data from our records. Further, we do
          not undertake tracking or behavioural monitoring of children or
        ...
        <Typography
          ...
          paragraph
        >
          We reserve the right to change this Policy at our sole discretion at
          any time. The updated version will be indicated by an updated
          "Revised" date and the updated version will be effective as soon as it
          is accessible. If we make material changes to this Policy, we may
          ...
          this Policy frequently to be informed of how we are protecting your
          information.
        </Typography>
